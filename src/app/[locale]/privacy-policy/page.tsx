...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Kick a Lucky Block Wiki',
    description: 'Kick a Lucky Block Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Kick a Lucky Block Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Kick a Lucky Block Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation or the developers of Kick a Lucky Block. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@kickaluckyblock.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@kickaluckyblock.wiki</a>
            </p>
            <p>
