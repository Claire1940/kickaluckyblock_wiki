...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Kick a Lucky Block Wiki",
    description: "Read the Terms of Service for Kick a Lucky Block Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Kick a Lucky Block Wiki",
      description: "Terms and conditions for using Kick a Lucky Block Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Kick a Lucky Block Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Kick a Lucky Block Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Kick a Lucky Block Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Kick a Lucky Block Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
            ...
            <p>
              ...
              Roblox Corporation or the official developers of Kick a Lucky Block. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Kick a Lucky Block Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Kick a Lucky Block. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Roblox game availability and updates may change without notice. We are not responsible for platform outages or game-side changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, KICK A LUCKY BLOCK WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Kick a Lucky Block Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@kickaluckyblock.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@kickaluckyblock.wiki</a>
            </p>
            <p>
