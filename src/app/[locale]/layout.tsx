...
const SITE_NAME = 'Kick a Lucky Block Wiki'
const SITE_TITLE = 'Kick a Lucky Block Wiki - Codes, Brainrots & Guide'
const SITE_DESCRIPTION =
	'Kick a Lucky Block Wiki with codes status, brainrot list, mutations, weights, rebirth tips, zones and beginner guides for the Roblox tycoon.'
